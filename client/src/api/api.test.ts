  ...
  describe("Products API", () => {
    ...
    describe("create", () => {
      it("should create a product", async () => {
        ...
        expect(mockedAxios.post).toHaveBeenCalledWith("http://90.156.227.180:3000/products", createData);
    ...
    describe("getAll", () => {
      it("should get all products", async () => {
        ...
        expect(mockedAxios.get).toHaveBeenCalledWith("http://90.156.227.180:3000/products");
    ...
    describe("getById", () => {
      it("should get product by id", async () => {
        ...
        expect(mockedAxios.get).toHaveBeenCalledWith(`http://90.156.227.180:3000/products/${id}`);
        expect(result).toEqual(mockProduct);
      });
    ...
    describe("update", () => {
      it("should update a product", async () => {
        ...
        expect(mockedAxios.patch).toHaveBeenCalledWith(`http://90.156.227.180:3000/products/${id}`, updateData);
  ...
  describe("Categories API", () => {
    ...
    describe("getAll", () => {
      it("should get all categories", async () => {
        ...
        expect(mockedAxios.get).toHaveBeenCalledWith("http://90.156.227.180:3000/categories");
    ...
    describe("getById", () => {
      it("should get category by id", async () => {
        ...
        expect(mockedAxios.get).toHaveBeenCalledWith(`http://90.156.227.180:3000/categories/${id}`);
    ...
    describe("create", () => {
      it("should create a category", async () => {
        ...
        expect(mockedAxios.post).toHaveBeenCalledWith("http://90.156.227.180:3000/categories", createData);
        expect(result).toEqual(mockCategory);
      });
    ...
    describe("delete", () => {
      it("should delete a category", async () => {
        ...
        expect(mockedAxios.delete).toHaveBeenCalledWith(`http://90.156.227.180:3000/categories/${id}`);
      });
    ...
    describe("update", () => {
      it("should update a category", async () => {
        ...
        expect(mockedAxios.patch).toHaveBeenCalledWith(`http://90.156.227.180:3000/categories/${id}`, updateData);
      });
  ...
  describe("Orders API", () => {
    ...
    describe("create", () => {
      it("should create an order", async () => {
        ...
        expect(mockedAxios.post).toHaveBeenCalledWith("http://90.156.227.180:3000/orders", createData);
    ...
    describe("getAll", () => {
      it("should get all orders", async () => {
        ...
        expect(mockedAxios.get).toHaveBeenCalledWith("http://90.156.227.180:3000/orders");
    ...
    describe("delete", () => {
      it("should delete an order", async () => {
        ...
        expect(mockedAxios.delete).toHaveBeenCalledWith(`http://90.156.227.180:3000/orders/${id}`);
      });
    ...
    describe("update", () => {
      it("should update an order", async () => {
        ...
        expect(mockedAxios.patch).toHaveBeenCalledWith(`http://90.156.227.180:3000/orders/${id}`, updateData);
  ...
  describe("Users API", () => {
    ...
    describe("create", () => {
      it("should create a user", async () => {
        ...
        expect(mockedAxios.post).toHaveBeenCalledWith("http://90.156.227.180:3000/users", createData);
    ...
    describe("getAll", () => {
      it("should get all users", async () => {
        ...
        expect(mockedAxios.get).toHaveBeenCalledWith("http://90.156.227.180:3000/users");
    ...
    describe("delete", () => {
      it("should delete a user", async () => {
        ...
        expect(mockedAxios.delete).toHaveBeenCalledWith(`http://90.156.227.180:3000/users/${id}`);
      });
    ...
    describe("update", () => {
      it("should update a user", async () => {
        ...
        expect(mockedAxios.patch).toHaveBeenCalledWith(`http://90.156.227.180:3000/users/${id}`, updateData);
      });
